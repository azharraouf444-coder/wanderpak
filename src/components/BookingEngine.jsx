...
export default function BookingEngine() {
    ...
    return (
        <section id="booking" className="py-24 bg-slate-50 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-sky-100 rounded-full blur-3xl opacity-50 translate-y-1/2 -translate-x-1/2"></div>
                    ...
                    <div className="flex border-b border-slate-100 bg-slate-50">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`flex-1 py-4 px-6 flex items-center justify-center gap-2 font-semibold text-sm transition-all duration-300 relative ${activeTab === tab.id ? "text-emerald-600 bg-white" : "text-slate-500 hover:text-slate-700 hover:bg-slate-100/50"}`}
                            >
                        ...
                        <AnimatePresence mode="wait">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <select className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 focus:ring-2 focus:ring-emerald-500 focus:outline-none appearance-none cursor-pointer">
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-semibold text-slate-700 ml-1">Check In - Check Out</label>
                                            <div className="relative flex gap-2">
                                                <div className="relative flex-1">
                                                    <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5 pointer-events-none" />
                                                    <input type="date" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-2 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none cursor-pointer" />
                                                </div>
                                                <div className="relative flex-1">
                                                    <input type="date" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-3 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none cursor-pointer" />
                                                </div>
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <label className="text-sm font-semibold text-slate-700 ml-1">Guests & Rooms</label>
                                            <div className="relative">
                            ...
                            {activeTab === "vehicle" && (
                                ...
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-sm font-semibold text-slate-700 ml-1">Pick Up Location</label>
                                            <div className="relative">
                                                <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5" />
                                                <input type="text" placeholder="e.g. Islamabad Airport" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-4 focus:ring-2 focus:ring-emerald-500 focus:outline-none" />
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <label className="text-sm font-semibold text-slate-700 ml-1">Vehicle Type</label>
                                            <div className="relative">
                                        ...
                                        <div className="space-y-2 md:col-span-2">
                                            <label className="text-sm font-semibold text-slate-700 ml-1">Pickup Date & Time</label>
                                            <div className="relative flex gap-2">
                                                <div className="relative flex-1">
                                                    <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5 pointer-events-none" />
                                                    <input type="date" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 pr-2 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none cursor-pointer" />
                                                ...
                                                <div className="relative flex-1">
                                                    <input type="time" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-3 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none cursor-pointer" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {activeTab === "payment" && (
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-sm font-semibold text-slate-700 ml-1">Select Payment Method</label>
                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            ...
                                            <div className="border border-slate-200 hover:border-emerald-300 rounded-xl p-4 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all">
                                                ...
                                                <span className="font-medium text-slate-700 text-sm">JazzCash</span>
                                            </div>
                                            ...
                                            <div className="border border-slate-200 hover:border-emerald-300 rounded-xl p-4 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all">
                                                ...
                                                <span className="font-medium text-slate-700 text-sm">Easypaisa</span>
                                            </div>
                                    ...
                                    <div className="space-y-4 pt-4 border-t border-slate-100">
                                        <div className="relative">
                                            <input type="text" placeholder="Card Number (Dummy Form)" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 focus:ring-2 focus:ring-emerald-500 focus:outline-none font-mono tracking-widest text-sm" />
                                        </div>
                                        <div className="grid grid-cols-2 gap-4">
                                            <input type="text" placeholder="MM/YY" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 focus:ring-2 focus:ring-emerald-500 focus:outline-none" />
                                            <input type="text" placeholder="CVC" className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 focus:ring-2 focus:ring-emerald-500 focus:outline-none" />
                                        </div>
                                    </div>
